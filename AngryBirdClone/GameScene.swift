...
//  AngryBirdClone
//
//  Created by apple on 24.11.2019.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let birdTexture = SKSpriteNode(imageNamed: "bird")
    ...
    //Bu fonksiyon bizim oluşturduğumuz kategorilerden birşey bir birine değerse çağrılacak
